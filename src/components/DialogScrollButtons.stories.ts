...
import DialogScrollButtons from './DialogScrollButtons.vue'

const meta = {
  title: 'Components/DialogScrollButtons',
    ...
    template: `
      <div style="padding: 20px; height: 500px; display: flex; flex-direction: column;">
        <p style="margin-bottom: 16px; color: #666;">
          Try the scroll buttons in the bottom-right corner or use keyboard shortcuts:
          <br>• Arrow Up/Down: Navigate between messages
          <br>• Home/End: Go to top/bottom
        </p>
